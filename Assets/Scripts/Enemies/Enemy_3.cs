...
public class Enemy_3 : Enemy
{
     ...
     *** Variables
     *************************************************************************************************/
     //Enemy_3 will move following a Bexier curve, which is a linear interpolation
     ...
     *************************************************************************************************/
     void Start ()
     {
          ...
          //Pick a random middle position in the botton half of the screen
          v = Vector3.zero;
          v.x = Random.Range(xMin, xMax);
          v.y = Random.Range(Utils.camBounds.min.y, 0f);
          points[1] = v;
