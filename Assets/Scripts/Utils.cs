...
public class Utils : MonoBehaviour
{
     ...
     *************************************************************************************************/
     ...
     }//public static Bounds BoundsUnion
     ...
     public static Bounds CombineBoundsOfChildren(GameObject go)
     {
          ...
          if (go.GetComponent<Renderer>() != null)
               //Expand b to contain the Renderers Bounds
     ...
     }//public static Bounds CombineBoundsOfChildren
     ...
     static public Bounds camBounds
     {
          get
          {
               //If camBounds hasnt been set yet
     ...
     {
          //The behavior of this function is different based on the BoundTest that has been selected
          ...
          switch (test)
          {
               ...
               //The offScreen test determines what off would need to be
               //applied to move any tiny part of lilB inside of bigB
     ...
     }//public static Vector3 BoundsInBoundsCheck
     ...
     *************************************************************************************************/
     ...
     //This function will iteratively climb up the transfom.parent tree until it either finds a parent
     ...
     }//public static GameObject FindTaggedParent
     ...
     *************************************************************************************************/
     ...
     }//static public Material[] GetAllMaterials
